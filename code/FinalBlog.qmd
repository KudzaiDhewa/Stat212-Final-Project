...
Through the player's lifetime statistics which are an indication of player's performance throughout their PUGB journey with critical information such as wins, matches played, survival we decided to using clustering techniques to examine some underlying structure of the players with respect to these statistics. Our assumption being naturally players would be grouped into different clusters which showcase their level of performance in the game.
